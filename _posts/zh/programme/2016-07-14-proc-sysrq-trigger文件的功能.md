...
tags: []
lang: zh
permalink: /zh/procsysrq-trigger-e6-96-87-e4-bb-b6-e7-9a-84-e5-8a-9f-e8-83-bd/
translations:
  zh: /zh/procsysrq-trigger-e6-96-87-e4-bb-b6-e7-9a-84-e5-8a-9f-e8-83-bd/
---
立即重启计算机
```shell
...
``` 
(可以用/var/log/message查看)Outputs memory statistics to the console  
