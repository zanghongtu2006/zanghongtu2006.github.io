...
lang: zh
permalink: /zh/cloudstack-e8-a7-a3-e6-9e-90-xenserver-rrd-1/
translations:
  zh: /zh/cloudstack-e8-a7-a3-e6-9e-90-xenserver-rrd-1/
---
 ...
 <meta>    #头信息
   ...
   <legend>                    #每列的数据名
     <entry>                   #每个entry是一列（row）
       AVERAGE:vm:52bf87dd-10ff-4d99-9042-66698cc5d6c6:cpu1 #entry的格式 AVERAGE：表示值是平均数
       vm：类型是vm，还可能是host等
       UUID：VM的UUID
       cpu1：表示第一个cpu
     </entry>
