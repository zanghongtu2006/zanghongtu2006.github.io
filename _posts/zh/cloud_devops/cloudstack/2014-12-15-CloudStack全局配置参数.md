...
`router.cpu.mhz`  
v-router默认CPU速度（MHz）；类型：整数；默认：500  
...
HyperV环境的v-router模板名字；类型：模板名字；默认：SystemVM Template (HyperV)

`router.template.kvm`  
KVM环境的v-router模板名字；类型：模板名字；默认：SystemVM Template (KVM)

`router.template.lxc`  
LXC环境的v-router模板名字；类型：模板名字；默认：SystemVM Template (LXC)

`router.template.vmware`  
Vmware环境的v-router模板；类型：模板名字；默认：SystemVM Template (vSphere)

`router.template.xen`  
XenServer环境的v-router模板；类型：模板名字；默认：SystemVM Template (XenServer)
