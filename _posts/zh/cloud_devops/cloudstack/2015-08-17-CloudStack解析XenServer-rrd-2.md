...
lang: zh
permalink: /zh/cloudstack-e8-a7-a3-e6-9e-90-xenserver-rrd-2/
translations:
  zh: /zh/cloudstack-e8-a7-a3-e6-9e-90-xenserver-rrd-2/
---
书接上文：[CloudStack 解析 XenServer RRD (1)]
了解了XenServer RRD格式之后，现在看一下CloudStack中是怎么解析RRD的。  
在之前的文章[CloudStack VM运行状态的监控-Hypervisor]  
